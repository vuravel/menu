...
<body>
    ...
    <div id="app">
        ...
        @includeWhen(!$VlHasAnyTopSidebar, 'vuravel-menu::menus.nav')

        <vl-alerts></vl-alerts>

        <div class="vlFlex vlWFull">

            @include('vuravel-menu::menus.sidebar', ['Sidebar' => $LeftSidebar])
            ...
            <div id="vl-wrapper" class="vlWFull">
                ...
                @includeWhen(!$VlFooterOutside, 'vuravel-menu::menus.footer')

            </div>

            @include('vuravel-menu::menus.sidebar', ['Sidebar' => $RightSidebar])
